...
- run_timestamp_utc: 2026-04-30T18:43:03.240463+00:00
...
- Actual date range used: 2021-04-30 → 2024-04-24
...
|---|---|
| total_sessions | 618 |
| entered | 64 (10.4% of sessions) |
| skipped (no_signal) | 554 |
| mean_forward_return | 0.2244% |
| median_forward_return | 0.2823% |
| hit_rate (forward > 0) | 68.8% |
| left_tail_p05 | -1.1285% |

## Verdict Rationale

`mean_forward_return = 0.2244%` > 0 → **EDGE_PRESENT** (simple verdict)
...
|---|---|
| sample size | 64 |
| std (per trade) | 0.8031% |
| sem (mean's std error) | 0.1004% |
| **t-stat** vs zero | **2.23** |
| **p-value** (two-tailed) | **0.029** |
| 95% CI on mean | [0.0238%, 0.4250%] |
