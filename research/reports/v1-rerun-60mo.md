...
- run_timestamp_utc: 2026-04-30T18:32:46.706400+00:00
...
- Actual date range used: 2021-05-03 → 2026-04-29
...
|---|---|
| total_sessions | 1224 |
| entered | 300 (24.5% of sessions) |
| skipped (no_signal) | 924 |
| mean_forward_return | 0.0845% |
| median_forward_return | 0.1527% |
| hit_rate (forward > 0) | 62.3% |
| left_tail_p05 | -1.1538% |

## Verdict Rationale

`mean_forward_return = 0.0845%` > 0 → **EDGE_PRESENT** (simple verdict)
...
|---|---|
| sample size | 300 |
| std (per trade) | 0.9521% |
| sem (mean's std error) | 0.0550% |
| **t-stat** vs zero | **1.54** |
| **p-value** (two-tailed) | **0.125** |
| 95% CI on mean | [-0.0237%, 0.1927%] |
...
|---|---|---|---|---|
| 2021 | 39 | 0.0698% | 0.4826% | 64.1% |
| 2022 | 88 | 0.1216% | 1.0606% | 62.5% |
| 2023 | 55 | 0.0740% | 0.5339% | 60.0% |
