...
- pop_threshold: 0.55
- max_loss_usd: $1000
- strike_width (long-walk gap criterion, $): 5.0
- strike_spacing: 5.0
- skew_strength: -0.5
...
- run_timestamp_utc: 2026-04-30T19:12:52.580301+00:00
...
| trades executed | 336 |
| skipped (monthly_stop) | 664 |
| skipped (no_viable_short) | 224 |
| **total P&L** | **$-63571.48** |
| mean P&L per trade | $-189.20 |
| median P&L per trade | $-255.74 |
| std P&L per trade | $168.77 |
| win rate | 21.1% |
| max single-trade win | $291.43 |
| max single-trade loss | $-355.51 |
| max drawdown (cumulative) | $-63327.15 |
| trades that armed (spot ≥ breakeven post-entry) | 336 |
| trades that stopped (spot < breakeven after armed) | 265 |
| months in window | 59 |
| winning months | 1 |
| months that hit cap | 55 |
