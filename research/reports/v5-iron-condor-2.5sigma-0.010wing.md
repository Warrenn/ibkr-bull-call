...
- run_timestamp_utc: 2026-04-30T18:26:38.613499+00:00
...
| **total P&L** | **$-6630** |
| mean P&L per trade | $-5.55 |
| median P&L per trade | $0.00 |
| std P&L per trade | $160.04 |
| win rate | 99.8% |
| max single-trade win | $0 |
| max single-trade loss | $-5393 |
| max drawdown (cumulative) | $-6630 |
| months in window | 60 |
| winning months | 58 |
