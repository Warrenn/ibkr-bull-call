# Directional Edge v3 — Phase 1 Falsification Test
...
- run_timestamp_utc: 2026-04-30T18:33:09.166595+00:00
...
|---|---|
| total_sessions | 829 |
| entered | 90 (10.9% of sessions) |
| skipped (no_signal) | 739 |
| mean_forward_return | 0.3034% |
| median_forward_return | 0.2380% |
| hit_rate (forward > 0) | 68.9% |
| left_tail_p05 | -1.0934% |

## Verdict Rationale

`mean_forward_return = 0.3034%` > 0 → **EDGE_PRESENT** (simple verdict)
...
|---|---|
| sample size | 90 |
| std (per trade) | 1.1897% |
| sem (mean's std error) | 0.1254% |
| **t-stat** vs zero | **2.42** |
| **p-value** (two-tailed) | **0.018** |
| 95% CI on mean | [0.0542%, 0.5526%] |
...
| 2023 | 9 | 0.2970% | 0.2265% | 88.9% |
| 2024 | 7 | 0.1702% | 0.1606% | 85.7% |
