...
- run_timestamp_utc: 2026-04-30T18:43:08.699672+00:00
...
- Actual date range used: 2024-04-25 → 2025-04-28
...
|---|---|
| total_sessions | 207 |
| entered | 16 (7.7% of sessions) |
| skipped (no_signal) | 191 |
| mean_forward_return | 0.6741% |
| median_forward_return | 0.2734% |
| hit_rate (forward > 0) | 68.8% |
| left_tail_p05 | -0.9720% |

## Verdict Rationale

`mean_forward_return = 0.6741%` > 0 → **EDGE_PRESENT** (simple verdict)
...
|---|---|
| sample size | 16 |
| std (per trade) | 2.3227% |
| sem (mean's std error) | 0.5807% |
| **t-stat** vs zero | **1.16** |
| **p-value** (two-tailed) | **0.264** |
| 95% CI on mean | [-0.5636%, 1.9118%] |
...
|---|---|---|---|---|
| 2024 | 6 | 0.1626% | 0.1746% | 83.3% |
| 2025 | 10 | 0.9809% | 2.9489% | 60.0% |
